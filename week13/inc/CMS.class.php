...
class CMS  
{
    ...
    function validate()
    {
        ...
        {
            // if not valid, set an error and flag as not valid
            $this->errors['h1'] = "Please enter a header";
            $isValid = false;
        } 
...
//var_dump($sql);die;        
    ...
    function saveBanner($fileArray) {
        move_uploaded_file($fileArray['tmp_name'], dirname(__FILE__) . "/../public/images/" . $this->data['cms_id'] . "_cms_banner.jpg");
    }
